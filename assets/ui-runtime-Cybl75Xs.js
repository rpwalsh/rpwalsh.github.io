var Ae=Object.defineProperty;var $e=(s,t,e)=>t in s?Ae(s,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):s[t]=e;var a=(s,t,e)=>$e(s,typeof t!="symbol"?t+"":t,e);class c extends HTMLElement{constructor(){super();a(this,"root");a(this,"_initialized",!1);this.root=this.attachShadow({mode:"open"})}connectedCallback(){this._injectTokenSheet(),this.render(),this._initialized=!0,this.onConnected()}disconnectedCallback(){this.onDisconnected()}attributeChangedCallback(e,r,o){this._initialized&&r!==o&&this.render()}onConnected(){}onDisconnected(){}styles(){return""}render(){const e=this.styles();this.root.innerHTML=(e?`<style>${e}</style>`:"")+this.template(),this.onRendered()}onRendered(){}getBoolAttr(e){return this.hasAttribute(e)}getAttr(e,r=""){return this.getAttribute(e)??r}getNumAttr(e,r=0){const o=this.getAttribute(e);return o!==null?Number(o):r}emit(e,r){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:r}))}$(e){return this.root.querySelector(e)}$$(e){return Array.from(this.root.querySelectorAll(e))}_injectTokenSheet(){const e=new CSSStyleSheet;e.replaceSync(`
    ...
    `}onRendered(){var t;(t=this.$(".delete-btn"))==null||t.addEventListener("click",e=>{e.stopPropagation(),this.emit("ui-delete")})}}a(q,"observedAttributes",["variant","size","color","deletable","disabled"]);l("ui-chip",q);class F extends c{styles(){return`
    ...
    `}}a(F,"observedAttributes",["content","variant","color","max"]);l("ui-badge",F);class P extends c{styles(){return`
      :host { display: inline-flex; }
    ...
    `}template(){const t=this.getAttr("src"),e=this.getAttr("alt",""),r=this.getAttr("size","md"),o=this.getAttr("variant","circular"),i=this.getAttr("initials"),n=t?`<img src="${t}" alt="${e}" />`:`<span class="fallback">${i||"?"}</span>`;return`<span class="avatar size-${r} variant-${o}" part="avatar" role="img" aria-label="${e||i||"avatar"}">${n}</span>`}}a(P,"observedAttributes",["src","alt","size","variant","initials"]);l("ui-avatar",P);class M extends c{constructor(){super(...arguments);a(this,"_timer",null);a(this,"_show",()=>{const e=this.getNumAttr("delay",200);this._timer=setTimeout(()=>this.classList.add("show"),e)});a(this,"_hide",()=>{this._timer&&clearTimeout(this._timer),this.classList.remove("show")})}styles(){return`
    ...
    `}onConnected(){this.addEventListener("mouseenter",this._show),this.addEventListener("mouseleave",this._hide),this.addEventListener("focusin",this._show),this.addEventListener("focusout",this._hide)}onDisconnected(){this.removeEventListener("mouseenter",this._show),this.removeEventListener("mouseleave",this._hide),this.removeEventListener("focusin",this._show),this.removeEventListener("focusout",this._hide),this._timer&&clearTimeout(this._timer)}}a(M,"observedAttributes",["content","placement","delay"]);l("ui-tooltip",M);class D extends c{styles(){return`
      :host { display: block; }
    ...
    `}}a(U,"observedAttributes",["value","variant","size","color"]);l("ui-progress",U);class Y extends c{styles(){return`
      :host { display: block; }
    ...
    `}template(){const t=this.getAttr("variant","text"),e=this.getAttr("width",t==="circular"?"40px":"100%"),r=this.getAttr("height",t==="circular"?"40px":t==="text"?"1em":"100px"),o=this.getAttr("animation","pulse");return`<span
      ...
      aria-hidden="true"
      part="skeleton"
    ></span>`}}a(Y,"observedAttributes",["variant","width","height","animation"]);l("ui-skeleton",Y);class ze extends HTMLElement{constructor(){super();a(this,"root");this.root=this.attachShadow({mode:"open"}),this.root.innerHTML=`
      <style>
        :host {
          position: fixed;
          z-index: 99999;
    ...
    `,this.root.appendChild(i);const n=()=>{i.classList.add("removing"),setTimeout(()=>i.remove(),200)};(d=i.querySelector(".close"))==null||d.addEventListener("click",n),o>0&&setTimeout(n,o)}}l("ui-toast-container",ze);class Q extends c{styles(){return":host{display:none;position:fixed;inset:0;z-index:100}:host([open]){display:grid;place-items:center}.backdrop{position:absolute;inset:0;background:rgb(2 6 23/.62);backdrop-filter:blur(var(--_blur,0))}:host([blur]){--_blur:4px}:host([invisible]) .backdrop{background:transparent}.content{position:relative;z-index:1}"}template(){return'<div class="backdrop" part="backdrop"></div><div class="content"><slot></slot></div>'}onRendered(){var t;(t=this.$(".backdrop"))==null||t.addEventListener("click",()=>this.emit("ui-dismiss"))}}a(Q,"observedAttributes",["open","blur","invisible"]);l("ui-backdrop",Q);class K extends c{styles(){return":host{display:grid;place-items:center;text-align:center;padding:var(--_padding,2.5rem);border:1px dashed var(--ui-color-border,#cbd5e1);border-radius:var(--ui-radius-lg,.75rem)}:host([compact]){--_padding:1rem}.wrap{display:grid;gap:.55rem;justify-items:center;max-width:30rem}.icon{font-size:1.75rem;color:var(--ui-color-text-secondary,#64748b)}h3,p{margin:0}p{color:var(--ui-color-text-secondary,#64748b);font-size:.875rem}.actions{margin-top:.5rem}"}template(){return`<div class="wrap"><div class="icon"><slot name="icon">◇</slot></div><h3>${this.getAttr("title")}</h3><p>${this.getAttr("description")}</p><div class="actions"><slot></slot></div></div>`}}a(K,"observedAttributes",["title","description","compact"]);l("ui-empty-state",K);class J extends c{get value(){return this.getAttr("value")}set value(t){this.setAttribute("value",t)}styles(){return`
      :host { display: block; }
      .tablist {
        display: flex;
        gap: 0;
    ...
    `}onConnected(){this.addEventListener("tab-select",(t=>{this.value=t.detail.value,this._syncPanels(),this.emit("ui-change",{value:this.value})})),requestAnimationFrame(()=>this._syncPanels())}_syncPanels(){const t=this.value;this.querySelectorAll("ui-tab").forEach(e=>{e.toggleAttribute("active",e.getAttribute("value")===t)}),this.querySelectorAll("ui-tab-panel").forEach(e=>{e.toggleAttribute("active",e.getAttribute("value")===t)})}}a(J,"observedAttributes",["value","variant","size"]);class G extends c{styles(){return`
      :host { display: inline-flex; }
    ...
    `}onRendered(){var t;(t=this.$("button"))==null||t.addEventListener("click",()=>{this.getBoolAttr("disabled")||this.dispatchEvent(new CustomEvent("tab-select",{bubbles:!0,composed:!0,detail:{value:this.getAttr("value")}}))})}}a(G,"observedAttributes",["value","label","active","disabled"]);class Z extends c{styles(){return`
      :host { display: none; }
      :host([active]) { display: block; padding: var(--ui-space-4, 1rem) 0; }
    `}template(){return"<slot></slot>"}}a(Z,"observedAttributes",["value","active"]);l("ui-tabs",J);l("ui-tab",G);l("ui-tab-panel",Z);class ee extends c{get open(){return this.getBoolAttr("open")}set open(t){t?this.setAttribute("open",""):this.removeAttribute("open")}styles(){return`
      :host { display: contents; }
    ...
    `}onRendered(){var t;(t=this.$(".backdrop"))==null||t.addEventListener("click",()=>{this.open=!1,this.emit("ui-close")})}}a(ee,"observedAttributes",["open","anchor","size","overlay"]);l("ui-drawer",ee);class te extends c{styles(){return`
      :host { display: block; }
    ...
    `}onConnected(){requestAnimationFrame(()=>this._insertSeparators())}_insertSeparators(){const t=this.getAttr("separator","/"),e=Array.from(this.children).filter(r=>!r.classList.contains("_bc-sep"));this.querySelectorAll("._bc-sep").forEach(r=>r.remove()),e.forEach((r,o)=>{if(o<e.length-1){const i=document.createElement("span");i.className="_bc-sep",i.setAttribute("aria-hidden","true"),i.textContent=` ${t} `,i.style.color="var(--ui-color-text-secondary, #64748b)",i.style.fontSize="var(--ui-text-sm, 0.875rem)",r.after(i)}})}}a(te,"observedAttributes",["separator"]);l("ui-breadcrumbs",te);class re extends c{get page(){return this.getNumAttr("page",1)}set page(t){this.setAttribute("page",String(t))}styles(){return`
      :host { display: inline-flex; }
    ...
    `}onRendered(){this.$$("button").forEach(t=>{t.addEventListener("click",()=>{const e=t.dataset.page;let r=this.page;e==="prev"?r=Math.max(1,r-1):e==="next"?r=Math.min(this.getNumAttr("count",1),r+1):r=Number(e),this.page=r,this.render(),this.emit("ui-change",{page:r})})})}_buildRange(t,e,r){const o=r*2+5;if(t<=o)return Array.from({length:t},(p,b)=>b+1);const i=Math.max(e-r,1),n=Math.min(e+r,t),d=i>2,h=n<t-1,u=[1];if(d)u.push("...");else for(let p=2;p<i;p++)u.push(p);for(let p=i;p<=n;p++)p!==1&&p!==t&&u.push(p);if(h)u.push("...");else for(let p=n+1;p<t;p++)u.push(p);return u.push(t),u}}a(re,"observedAttributes",["count","page","sibling-count","size"]);l("ui-pagination",re);class ie extends c{styles(){return":host{display:block;position:var(--_position,relative);inset:var(--_inset,auto);z-index:var(--_z,auto)}:host([position=sticky]){--_position:sticky;--_inset:0 0 auto;--_z:20}:host([position=fixed]){--_position:fixed;--_inset:0 0 auto;--_z:20}header{display:flex;align-items:center;min-height:3.5rem;padding:0 1rem;color:var(--ui-color-text);background:var(--ui-color-surface);border-bottom:1px solid var(--ui-color-border,#cbd5e1)}:host([color=primary]) header{background:var(--ui-color-primary,#4f46e5);color:#fff}:host([elevation]) header{box-shadow:0 4px 16px rgb(0 0 0/.2)}"}template(){return"<header><slot></slot></header>"}}a(ie,"observedAttributes",["position","color","elevation"]);class Se extends c{styles(){return":host{display:flex;align-items:center;gap:.75rem;width:100%;min-height:3rem}::slotted([data-spacer]){margin-inline-start:auto}"}template(){return"<slot></slot>"}}l("ui-app-bar",ie);l("ui-toolbar",Se);class se extends c{styles(){return":host{display:block}.item{display:flex;align-items:center;gap:.625rem;min-height:2.5rem;padding:.45rem .75rem;cursor:pointer;border-radius:var(--ui-radius-sm,.25rem);font-size:.875rem}.item:hover,.item:focus-visible{outline:0;background:color-mix(in srgb,var(--ui-color-primary,#4f46e5) 10%,transparent)}:host([selected]) .item{color:var(--ui-color-primary,#4f46e5);background:color-mix(in srgb,var(--ui-color-primary,#4f46e5) 14%,transparent)}:host([disabled]) .item{opacity:.45;pointer-events:none}"}template(){return`<div class="item" role="menuitem" tabindex="${this.getBoolAttr("disabled")?"-1":"0"}" aria-disabled="${this.getBoolAttr("disabled")}"><slot></slot></div>`}onRendered(){var e,r;const t=()=>this.emit("ui-select",{value:this.getAttr("value")});(e=this.$(".item"))==null||e.addEventListener("click",t),(r=this.$(".item"))==null||r.addEventListener("keydown",o=>{(o.key==="Enter"||o.key===" ")&&t()})}}a(se,"observedAttributes",["disabled","selected","value"]);class oe extends c{styles(){return":host{display:inline-block;position:relative}.menu{position:absolute;z-index:50;inset:calc(100% + .25rem) auto auto 0;min-width:12rem;padding:.25rem;color:var(--ui-color-text);background:var(--ui-color-surface);border:1px solid var(--ui-color-border,#cbd5e1);border-radius:var(--ui-radius-md,.5rem);box-shadow:0 14px 34px rgb(0 0 0/.24)}:host(:not([open])) .menu{display:none}"}template(){return`<div class="menu" role="menu" aria-label="${this.getAttr("label","Menu")}"><slot></slot></div>`}onRendered(){this.addEventListener("ui-select",()=>{this.removeAttribute("open")}),this.$$("slot")}}a(oe,"observedAttributes",["open","label"]);l("ui-menu-item",se);l("ui-menu",oe);class ae extends c{styles(){return":host{display:inline-block;position:relative}.surface{position:absolute;z-index:50;min-width:14rem;padding:.75rem;color:var(--ui-color-text);background:var(--ui-color-surface);border:1px solid var(--ui-color-border,#cbd5e1);border-radius:var(--ui-radius-md,.5rem);box-shadow:0 16px 38px rgb(0 0 0/.24)}:host(:not([open])) .surface{display:none}:host(:not([placement])) .surface,:host([placement=bottom-start]) .surface{inset:calc(100% + .4rem) auto auto 0}:host([placement=bottom-end]) .surface{inset:calc(100% + .4rem) 0 auto auto}:host([placement=top]) .surface{inset:auto auto calc(100% + .4rem) 50%;transform:translateX(-50%)}:host([placement=right]) .surface{inset:50% auto auto calc(100% + .4rem);transform:translateY(-50%)}"}template(){return`<slot name="anchor"></slot><div class="surface" role="dialog" aria-label="${this.getAttr("label","Popover")}"><slot></slot></div>`}}a(ae,"observedAttributes",["open","placement","label"]);l("ui-popover",ae);class ne extends c{styles(){return":host{display:flex;flex:1;min-width:8rem;position:relative}.step{display:grid;grid-template-columns:2rem 1fr;gap:.55rem;align-items:start;width:100%}.marker{display:grid;place-items:center;width:2rem;height:2rem;border-radius:50%;border:1px solid var(--ui-color-border,#cbd5e1);background:var(--ui-color-surface);font-size:.75rem;font-weight:700}:host([status=active]) .marker,:host([status=complete]) .marker{border-color:var(--ui-color-primary,#4f46e5);background:var(--ui-color-primary,#4f46e5);color:#fff}.copy{display:grid;gap:.15rem}.copy small{color:var(--ui-color-text-secondary,#64748b)}"}template(){const t=this.getAttr("status")==="complete";return`<div class="step" aria-current="${this.getAttr("status")==="active"?"step":"false"}"><span class="marker">${t?"✓":this.getAttr("index","1")}</span><span class="copy"><strong>${this.getAttr("label")}<slot></slot></strong><small>${this.getAttr("description")}</small></span></div>`}}a(ne,"observedAttributes",["label","description","status","index"]);class le extends c{styles(){return":host{display:flex;gap:1rem;width:100%}:host([orientation=vertical]){display:grid}"}template(){return'<div role="list" style="display:contents"><slot></slot></div>'}}a(le,"observedAttributes",["orientation"]);l("ui-step",ne);l("ui-stepper",le);class ce extends c{styles(){return`
      :host { display: block; }
      .accordion {
        border: 1px solid var(--ui-color-border, #e2e8f0);
        border-radius: var(--ui-radius-md, 0.5rem);
    ...
    `}template(){return'<div class="accordion" part="accordion"><slot></slot></div>'}onConnected(){this.addEventListener("accordion-toggle",(t=>{this.getBoolAttr("multiple")||this.querySelectorAll("ui-accordion-item").forEach(r=>{r!==t.detail.element&&r.removeAttribute("open")}),this.emit("ui-change",{value:t.detail.value,open:t.detail.open})}))}}a(ce,"observedAttributes",["multiple"]);class de extends c{get open(){return this.getBoolAttr("open")}set open(t){t?this.setAttribute("open",""):this.removeAttribute("open")}styles(){return`
      :host { display: block; }
    ...
    `}onRendered(){var t;(t=this.$(".header"))==null||t.addEventListener("click",()=>{this.getBoolAttr("disabled")||(this.open=!this.open,this.render(),this.dispatchEvent(new CustomEvent("accordion-toggle",{bubbles:!0,composed:!0,detail:{value:this.getAttr("value"),open:this.open,element:this}})))})}}a(de,"observedAttributes",["value","label","open","disabled"]);l("ui-accordion",ce);l("ui-accordion-item",de);class ue extends c{styles(){return`
      :host { display: block; }
    ...
    `}}a(ue,"observedAttributes",["variant","elevation"]);l("ui-paper",ue);class pe extends c{styles(){return":host { display: block; }"}template(){const t=this.getAttr("p"),e=this.getAttr("m"),r=this.getAttr("display"),o=this.getAttr("bg"),i=[t?`padding:${t}`:"",e?`margin:${e}`:"",r?`display:${r}`:"",o?`background:${o}`:""].filter(Boolean).join(";");return`<div ${i?`style="${i}"`:""} part="box"><slot></slot></div>`}}a(pe,"observedAttributes",["p","m","display","bg"]);l("ui-box",pe);class he extends c{styles(){return`
      :host { display: flex; }
    `}template(){const t=this.getAttr("direction","column"),e=this.getAttr("gap","var(--ui-space-3, 0.75rem)"),r=this.getAttr("align"),o=this.getAttr("justify"),i=this.getBoolAttr("wrap");return`<div style="${["display:flex",`flex-direction:${t}`,`gap:${e}`,r?`align-items:${r}`:"",o?`justify-content:${o}`:"",i?"flex-wrap:wrap":""].filter(Boolean).join(";")}" part="stack"><slot></slot></div>`}}a(he,"observedAttributes",["direction","gap","align","justify","wrap"]);l("ui-stack",he);class be extends c{styles(){return":host { display: block; }"}template(){const t=this.getAttr("columns","repeat(12, 1fr)"),e=this.getAttr("gap","var(--ui-space-4, 1rem)"),r=this.getAttr("rows");return`<div style="${["display:grid",`grid-template-columns:${t}`,`gap:${e}`,r?`grid-template-rows:${r}`:""].filter(Boolean).join(";")}" part="grid"><slot></slot></div>`}}a(be,"observedAttributes",["columns","gap","rows"]);l("ui-grid",be);class ge extends c{styles(){return`
      :host { display: block; }
      .divider {
        border: none;
        background: var(--ui-color-border, #e2e8f0);
    ...
    `}template(){const t=this.getAttr("orientation","horizontal"),e=this.getAttr("color");return`<hr class="divider ${t}" role="separator" aria-orientation="${t}" ${e?`style="background:${e}"`:""} part="divider" />`}}a(ge,"observedAttributes",["orientation","color"]);l("ui-divider",ge);class ve extends c{styles(){return`
      :host { display: contents; }
    ...
    `}template(){return"<slot></slot>"}}a(ve,"observedAttributes",["mode"]);l("ui-theme-provider",ve);const w={version:1,query:"",filters:{},timeWindow:null,selection:null,compare:{enabled:!1},panels:{}};function k(s){return{...w,...s,filters:{...w.filters,...(s==null?void 0:s.filters)??{}},compare:{...w.compare,...(s==null?void 0:s.compare)??{}},panels:Ie(w.panels,s==null?void 0:s.panels)}}function Ee(s,t){switch(t.type){case"setQuery":return{...s,query:t.query};case"setFilter":return{...s,filters:_(s.filters,t.key,t.value)};case"setPanelFilter":{const e=s.panels[t.panelId]??{};return{...s,panels:{...s.panels,[t.panelId]:{...e,filters:_(e.filters??{},t.key,t.value)}}}}case"setTimeWindow":return{...s,timeWindow:t.timeWindow?{...t.timeWindow}:null};case"setSelection":return{...s,selection:Ce(t.selection)};case"setCompare":return{...s,compare:{...s.compare,...t.compare}};case"patchPanelState":{const e=s.panels[t.panelId]??{},r={...e,...t.patch,filters:t.patch.filters?{...e.filters??{},...t.patch.filters}:e.filters};return{...s,panels:{...s.panels,[t.panelId]:r}}}case"restoreSavedView":return k(t.view);case"reset":return k(t.state);default:return s}}function Le(s){let t=k(s);const e=new Set,r=i=>{t=Ee(t,i);for(const n of e)n(t)};return{getState(){return t},dispatch:r,subscribe(i){return e.add(i),()=>{e.delete(i)}},actions:{setQuery(i){r({type:"setQuery",query:i})},setFilter(i,n){r({type:"setFilter",key:i,value:n})},setPanelFilter(i,n,d){r({type:"setPanelFilter",panelId:i,key:n,value:d})},setTimeWindow(i){r({type:"setTimeWindow",timeWindow:i})},setSelection(i){r({type:"setSelection",selection:i})},setCompare(i){r({type:"setCompare",compare:i})},patchPanelState(i,n){r({type:"patchPanelState",panelId:i,patch:n})},restoreSavedView(i){r({type:"restoreSavedView",view:i})},reset(i){r({type:"reset",state:i})}}}}function _(s,t,e){const r={...s};return e===void 0?(delete r[t],r):(r[t]=e,r)}function Ie(s,t){var r;const e={};for(const[o,i]of Object.entries(s))e[o]={...i,filters:i.filters?{...i.filters}:void 0};for(const[o,i]of Object.entries(t??{}))e[o]={...e[o]??{},...i,filters:{...((r=e[o])==null?void 0:r.filters)??{},...i.filters??{}}};return e}function Ce(s){return s?{...s,meta:s.meta?{...s.meta}:void 0}:null}const me={background:"#0b1220",surface:"#101a2d",surfaceMuted:"#162238",border:"#22324d",text:"#e6edf7",textMuted:"#99abc7",accent:"#4c8dff",accentSoft:"rgba(76, 141, 255, 0.18)",positive:"#29b37d",warning:"#f2b84b",danger:"#ef6464",navWidth:"248px",inspectorWidth:"320px",topbarHeight:"72px",statusHeight:"36px",radius:"16px",gap:"16px",panelPadding:"16px",shadow:"0 18px 44px rgba(3, 10, 24, 0.28)",fontFamily:'"Segoe UI", Inter, "Helvetica Neue", Arial, sans-serif'},Be={background:"#f5f7fb",surface:"#ffffff",surfaceMuted:"#eef3fb",border:"#d8e2f1",text:"#122033",textMuted:"#5f718a",accent:"#2764ff",accentSoft:"rgba(39, 100, 255, 0.12)",positive:"#1f8b5f",warning:"#b8800e",danger:"#c53f3f",navWidth:"248px",inspectorWidth:"320px",topbarHeight:"72px",statusHeight:"36px",radius:"16px",gap:"16px",panelPadding:"16px",shadow:"0 18px 44px rgba(15, 23, 42, 0.08)",fontFamily:'"Segoe UI", Inter, "Helvetica Neue", Arial, sans-serif'},Ne={...me,background:"#05070a",surface:"#0c1117",surfaceMuted:"#111923",border:"#93a4c2",text:"#ffffff",textMuted:"#c8d3e5",accent:"#7fb0ff",accentSoft:"rgba(127, 176, 255, 0.2)",positive:"#6ce3aa",warning:"#ffd56b",danger:"#ff9b9b"};function Te(s="dark",t){return{...s==="light"?Be:s==="high-contrast"?Ne:me,...t}}function Re(s){return{"--rlwb-bg":s.background,"--rlwb-surface":s.surface,"--rlwb-surface-muted":s.surfaceMuted,"--rlwb-border":s.border,"--rlwb-text":s.text,"--rlwb-text-muted":s.textMuted,"--rlwb-accent":s.accent,"--rlwb-accent-soft":s.accentSoft,"--rlwb-positive":s.positive,"--rlwb-warning":s.warning,"--rlwb-danger":s.danger,"--rlwb-nav-width":s.navWidth,"--rlwb-inspector-width":s.inspectorWidth,"--rlwb-topbar-height":s.topbarHeight,"--rlwb-status-height":s.statusHeight,"--rlwb-radius":s.radius,"--rlwb-gap":s.gap,"--rlwb-panel-padding":s.panelPadding,"--rlwb-shadow":s.shadow,"--rlwb-font-family":s.fontFamily}}const A=[{label:"1h",value:{preset:"1h",label:"Last hour"}},{label:"24h",value:{preset:"24h",label:"Last 24 hours"}},{label:"7d",value:{preset:"7d",label:"Last 7 days"}},{label:"30d",value:{preset:"30d",label:"Last 30 days"}}];function x(s,t){if(t)return t;const e=s.closest("ui-workbench-shell");return(e==null?void 0:e.workbenchStore)??(e==null?void 0:e.store)??null}function je(s,t){const e=Re(Te(s,t));return Object.entries(e).map(([r,o])=>`${r}:${o}`).join(";")}function m(s){return s?s.assignedNodes({flatten:!0}).some(t=>t.nodeType===Node.ELEMENT_NODE?!0:t.nodeType===Node.TEXT_NODE?(t.textContent??"").trim().length>0:!1):!1}function f(s){return(s==null?"":String(s)).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function fe(s,t){return Array.isArray(s)&&Array.isArray(t)?s.length!==t.length?!1:s.every((e,r)=>e===t[r]):s===t}function qe(s,t){return Array.isArray(s)&&!Array.isArray(t)?s.includes(t):fe(s,t)}function Fe(s,t,e){if(!e)return fe(s,t)?void 0:t;const r=Array.isArray(t)?t[0]:t,o=Array.isArray(s)?[...s]:s===void 0?[]:[s],i=o.findIndex(n=>n===r);return i>=0?o.splice(i,1):o.push(r),o.length>0?o:void 0}function Pe(s,t){return!s&&!t?!0:!s||!t?!1:s.preset===t.preset&&s.from===t.from&&s.to===t.to&&s.timezone===t.timezone&&s.label===t.label}function Me(s){if(!s)return"";const t=[["Panel",s.panelId],["Entity",s.entityId],["Series",s.seriesId],["Point",s.pointId],["Label",s.label]];for(const[r,o]of Object.entries(s.meta??{}))t.push([r,typeof o=="object"?JSON.stringify(o):o]);const e=t.filter(([,r])=>r!=null&&String(r).trim().length>0).map(([r,o])=>`<dt>${f(r)}</dt><dd>${f(o)}</dd>`).join("");return e?`<dl class="rlwb-selection-list">${e}</dl>`:""}const g=`
  :host {
    display: block;
    box-sizing: border-box;
    min-width: 0;
...
`;class xe extends c{constructor(){super(...arguments);a(this,"_store");a(this,"_theme");a(this,"_initialState");a(this,"hasNav",!1);a(this,"hasInspector",!1);a(this,"hasTopbar",!1);a(this,"hasStatus",!1)}get tone(){return this.getAttribute("tone")??"dark"}set tone(e){this.setAttribute("tone",e)}get theme(){return this._theme}set theme(e){this._theme=e,this.render()}get initialState(){return this._initialState}set initialState(e){this._initialState=e,this._store||this.render()}get store(){return this._store||(this._store=Le(this._initialState)),this._store}set store(e){this._store=e??void 0,this.render()}get workbenchStore(){return this.store}styles(){return g}template(){return`
      <div data-rl-workbench="" class="${["rlwb-shell",this.hasNav&&"rlwb-shell--has-nav",this.hasInspector&&"rlwb-shell--has-inspector"].filter(Boolean).join(" ")}" style="${je(this.tone,this._theme)}">
    ...
    `}onRendered(){const e=this.$('slot[name="nav"]'),r=this.$('slot[name="topbar"]'),o=this.$('slot[name="inspector"]'),i=this.$('slot[name="status"]'),n=()=>{const d=m(e),h=m(r),u=m(o),p=m(i);(d!==this.hasNav||h!==this.hasTopbar||u!==this.hasInspector||p!==this.hasStatus)&&(this.hasNav=d,this.hasTopbar=h,this.hasInspector=u,this.hasStatus=p,this.render())};e==null||e.addEventListener("slotchange",n),r==null||r.addEventListener("slotchange",n),o==null||o.addEventListener("slotchange",n),i==null||i.addEventListener("slotchange",n),n()}}a(xe,"observedAttributes",["tone"]);l("ui-workbench-shell",xe);class ye extends c{styles(){return g}template(){const t=this.getAttribute("columns"),e=this.getAttribute("rows")??"",r=this.getAttribute("min-column-width"),o=r?`repeat(auto-fit, minmax(${r}, 1fr))`:t?/^\d+$/.test(t)?`repeat(${t}, 1fr)`:t:"repeat(auto-fit, minmax(320px, 1fr))";return`
      <div
    ...
    `}}a(ye,"observedAttributes",["columns","rows","min-column-width","dense"]);l("ui-workbench-panel-layout",ye);class we extends c{constructor(){super(...arguments);a(this,"_store");a(this,"unsubscribe");a(this,"localPanelState",{});a(this,"hasFooter",!1)}get store(){return this._store}set store(e){this._store=e,this.syncSubscription(),this.render()}onConnected(){this.syncSubscription()}onDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}styles(){return g}template(){const e=this.getAttribute("title")??"",r=this.getAttribute("subtitle")??"",o=this.getAttribute("padding")??"md",i=this.getAttribute("tone")??"default",n=this.getPanelState(),d=this.hasAttribute("collapsible"),h=!!n.collapsed;return`
    ...
    `}onRendered(){const e=this.$('[data-action="toggle"]');e==null||e.addEventListener("click",()=>{const i=this.getAttribute("panel-id"),n=this.getPanelState(),d={collapsed:!n.collapsed},h=this.resolveStore();i&&h?h.actions.patchPanelState(i,d):(this.localPanelState={...n,...d},this.render())});const r=this.$('slot[name="footer"]'),o=()=>{const i=m(r);i!==this.hasFooter&&(this.hasFooter=i,this.render())};r==null||r.addEventListener("slotchange",o),o()}resolveStore(){return x(this,this._store)}getPanelState(){const e=this.getAttribute("panel-id"),r=this.resolveStore(),o=e&&r?r.getState().panels[e]:void 0;return{collapsed:this.hasAttribute("default-collapsed"),...this.localPanelState,...o}}syncSubscription(){var o;(o=this.unsubscribe)==null||o.call(this);const e=this.resolveStore(),r=this.getAttribute("panel-id");!e||!r||!this.isConnected||(this.unsubscribe=e.subscribe(()=>{this.render()}))}}a(we,"observedAttributes",["panel-id","title","subtitle","collapsible","default-collapsed","padding","tone"]);l("ui-workbench-panel",we);class ke extends c{constructor(){super(...arguments);a(this,"_store");a(this,"unsubscribe")}get store(){return this._store}set store(e){this._store=e,this.syncSubscription(),this.render()}onConnected(){this.syncSubscription()}onDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}styles(){return g}template(){var i;const e=this.getAttribute("label")??"Query",r=this.getAttribute("placeholder")??"Search, scope, or command",o=((i=this.resolveStore())==null?void 0:i.getState().query)??"";return`
    ...
    `}onRendered(){const e=this.$(".rlwb-query-input");e==null||e.addEventListener("input",r=>{var i;const o=r.currentTarget.value;(i=this.resolveStore())==null||i.actions.setQuery(o),this.emit("ui-query-change",{value:o})})}resolveStore(){return x(this,this._store)}syncSubscription(){var r;(r=this.unsubscribe)==null||r.call(this);const e=this.resolveStore();!e||!this.isConnected||(this.unsubscribe=e.subscribe(()=>{this.render()}))}}a(ke,"observedAttributes",["label","placeholder"]);l("ui-workbench-query-bar",ke);class De extends c{constructor(){super(...arguments);a(this,"_store");a(this,"_filters",[]);a(this,"unsubscribe")}get store(){return this._store}set store(e){this._store=e,this.syncSubscription(),this.render()}get filters(){return this._filters}set filters(e){this._filters=e,this.render()}onConnected(){this.syncSubscription()}onDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}styles(){return g}template(){var o;const e=(o=this.resolveStore())==null?void 0:o.getState();return`<div class="rlwb-filter-bar">${this._filters.map(i=>{var h,u;const n=i.scope==="panel"?(u=(h=e==null?void 0:e.panels[i.panelId??""])==null?void 0:h.filters)==null?void 0:u[i.key]:e==null?void 0:e.filters[i.key],d=i.options.map((p,b)=>`
            <button
              type="button"
              class="rlwb-filter-chip"
              data-filter-key="${f(i.key)}"
              data-filter-index="${b}"
              aria-pressed="${qe(n,p.value)}"
            >
              ${f(p.label)}
            </button>
          `).join("");return`
        ...
        `}).join("")}</div>`}onRendered(){this.$$(".rlwb-filter-chip").forEach(e=>{e.addEventListener("click",()=>{var p,b;const r=e.dataset.filterKey??"",o=Number(e.dataset.filterIndex??"-1"),i=this._filters.find(v=>v.key===r),n=i==null?void 0:i.options[o],d=this.resolveStore();if(!i||!n||!d)return;const h=i.scope==="panel"?(b=(p=d.getState().panels[i.panelId??""])==null?void 0:p.filters)==null?void 0:b[i.key]:d.getState().filters[i.key],u=Fe(h,n.value,!!i.multi);i.scope==="panel"&&i.panelId?d.actions.setPanelFilter(i.panelId,i.key,u):d.actions.setFilter(i.key,u),this.emit("ui-filter-change",{key:i.key,panelId:i.panelId,scope:i.scope??"global",value:u})})})}resolveStore(){return x(this,this._store)}syncSubscription(){var r;(r=this.unsubscribe)==null||r.call(this);const e=this.resolveStore();!e||!this.isConnected||(this.unsubscribe=e.subscribe(()=>{this.render()}))}}l("ui-workbench-filter-bar",De);class We extends c{constructor(){super(...arguments);a(this,"_store");a(this,"_options",A);a(this,"unsubscribe")}get store(){return this._store}set store(e){this._store=e,this.syncSubscription(),this.render()}get options(){return this._options}set options(e){this._options=e.length>0?e:A,this.render()}onConnected(){this.syncSubscription()}onDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}styles(){return g}template(){var o;const e=(o=this.resolveStore())==null?void 0:o.getState().timeWindow;return`<div class="rlwb-time-range">${this._options.map((i,n)=>`
        <button
          type="button"
          class="rlwb-filter-chip"
          data-option-index="${n}"
          aria-pressed="${Pe(e,i.value)}"
        >
          ${f(i.label)}
        </button>
      `).join("")}</div>`}onRendered(){this.$$(".rlwb-filter-chip").forEach(e=>{e.addEventListener("click",()=>{var i;const r=Number(e.dataset.optionIndex??"-1"),o=this._options[r];o&&((i=this.resolveStore())==null||i.actions.setTimeWindow(o.value),this.emit("ui-time-window-change",{value:o.value}))})})}resolveStore(){return x(this,this._store)}syncSubscription(){var r;(r=this.unsubscribe)==null||r.call(this);const e=this.resolveStore();!e||!this.isConnected||(this.unsubscribe=e.subscribe(()=>{this.render()}))}}l("ui-workbench-time-range-control",We);class _e extends c{constructor(){super(...arguments);a(this,"_store");a(this,"_renderContent");a(this,"unsubscribe");a(this,"hasActions",!1)}get store(){return this._store}set store(e){this._store=e,this.syncSubscription(),this.render()}get renderContent(){return this._renderContent}set renderContent(e){this._renderContent=e,this.render()}onConnected(){this.syncSubscription()}onDisconnected(){var e;(e=this.unsubscribe)==null||e.call(this),this.unsubscribe=void 0}styles(){return g}template(){var n;const e=this.getAttribute("title")??"Inspector",r=this.getAttribute("empty-state")??"Select a record, point, or entity to inspect it here.",o=((n=this.resolveStore())==null?void 0:n.getState().selection)??null,i=this._renderContent?"":o?Me(o):`<div class="rlwb-empty-state">${r}</div>`;return`
    ...
    `}onRendered(){var d;const e=this.$('slot[name="actions"]'),r=()=>{const h=m(e);h!==this.hasActions&&(this.hasActions=h,this.render())};if(e==null||e.addEventListener("slotchange",r),r(),!this._renderContent)return;const o=this.$('[data-role="body"]');if(!o)return;o.innerHTML="";const i=((d=this.resolveStore())==null?void 0:d.getState().selection)??null,n=this._renderContent(i);if(typeof n=="string"){o.innerHTML=n;return}if(n instanceof Node){o.append(n);return}i||(o.innerHTML=`<div class="rlwb-empty-state">${this.getAttribute("empty-state")??"Select a record, point, or entity to inspect it here."}</div>`)}resolveStore(){return x(this,this._store)}syncSubscription(){var r;(r=this.unsubscribe)==null||r.call(this);const e=this.resolveStore();!e||!this.isConnected||(this.unsubscribe=e.subscribe(()=>{this.render()}))}}a(_e,"observedAttributes",["title","empty-state"]);l("ui-workbench-entity-inspector",_e);export{$ as U,z as a,S as b,L as c,q as d,X as e,W as f,l as r};
